<?php
/**
 * Deneb Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Deneb_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_image_checkbox';
	 ...
	 */
	class Deneb_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_text_radio_button';
	 ...
	 */
	class Deneb_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_image_radio_button';
	 ...
	 */
	class Deneb_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_simple_notice';
	 ...
	 */
	class Deneb_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_slider_control';
	 ...
	 */
	class Deneb_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_toggle_switch';
	 ...
	 */
	class Deneb_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_sortable_repeater';
	 ...
	 */
	class Deneb_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_dropdown_select2';
	 ...
	 */
	class Deneb_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_dropdown_posts';
					...
					<?php
						if( !empty( $this->posts ) ) {
							foreach ( $this->posts as $post ) {
								...
								if ( empty( $title ) ) {
									$title = sprintf( esc_html__( 'ID: %s No Title', 'deneb' ), $post->ID );
								}
	 ...
	 */
	class Deneb_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['denebtinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['denebtinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['denebmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class Deneb_Note_Control extends WP_Customize_Control {
		public $type = 'deneb_description';
	 ...
	 *
	 */
	class Deneb_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'deneb_deneb-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="deneb_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'deneb_url_sanitization' ) ) {
		function deneb_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'deneb_switch_sanitization' ) ) {
		function deneb_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'deneb_radio_sanitization' ) ) {
		function deneb_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'deneb_text_sanitization' ) ) {
		function deneb_text_sanitization( $input ) {
	 ...
	 */
	function deneb_sanitize_select( $input, $setting ) {
