...
function deneb_register_meta_boxes() {
	add_meta_box( 'deneb-featured-image-options', esc_html__( 'Featured Image', 'deneb' ), 'deneb_display_featured_image_options', array( 'post', 'page' ), 'side' );
}
...
function deneb_display_featured_image_options( $post ) {
	...
	$featured_image_options = array(
		'default'                   => esc_html__( 'Default', 'deneb' ),
		'disabled'                  => esc_html__( 'Disabled', 'deneb' ),
		'post-thumbnail'            => esc_html__( 'Post Thumbnail (470x470)', 'deneb' ),
		'deneb-slider' => esc_html__( 'Slider Image (1920x954)', 'deneb' ),
		'full'                      => esc_html__( 'Original Image Size', 'deneb' ),
	);

	$meta_option = get_post_meta( $post->ID, 'deneb-featured-image', true );
	...
	?>
	<select name="deneb-featured-image"> 
		<?php
