...
Deneb WordPress Theme, Copyright 2021 FireFly Themes
...
Deneb includes support for Infinite Scroll in Jetpack, Breadcrunb NXT for advanced breadcrumb solution.
...
* Added: Telegram and Vk icon support

= 1.0.2 - 31 October 2020 =
* Update: Theme Description
* Fix: Textdomain issue
* Fix: Custom control type prefix issue

= 1.0.1 - 24 October 2020 =
* Fix: Textdomain issue
...
Images
	All images are licensed under [CC0] (https://creativecommons.org/publicdomain/zero/1.0/)
		* Screenshot and header image: https://pxhere.com/en/photo/1456581
